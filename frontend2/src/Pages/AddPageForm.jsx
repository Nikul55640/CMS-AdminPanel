...
const AddPageForm = () => {
  ...
  return (
    ...
    >
      ...
      <div className="p-8 space-y-6 border-1 rounded-br-2xl rounded-bl-2xl">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:outline-none min-h-[100px] transition"
          />
        </div>
      ...
      {/* Footer Buttons */}
      <div className="bg-gray-50 px-8 py-6 flex justify-between sm:justify-end gap-4 border-t">
        <motion.button
        ...
        <motion.button
          ...
          className={`px-5 py-3 rounded-xl font-semibold text-white shadow-md transition duration-200 ${
            isSaving
